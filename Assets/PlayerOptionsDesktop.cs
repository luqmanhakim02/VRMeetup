...
namespace XRMultiplayer
{
    ...
    public class PlayerOptionsDesktop : MonoBehaviour
    {
        const string k_DebugPrepend = "<color=#938FFF>[PLayer Option Desktop]</color> ";
        ...
        private void Update()
        {
            ...
            // Handle ESC key to open/close menu
        ...
        {
            Utils.Log($"{k_DebugPrepend}Connected Status: {connected}");
