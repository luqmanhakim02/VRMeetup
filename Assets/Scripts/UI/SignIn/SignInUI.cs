...
namespace XRMultiplayer
{
    public class SignInUI : MonoBehaviour
    {
        ...
        [Header("Dependencies")]
        [SerializeField] AuthManager m_AuthenticationManager;
        ...
        private void Awake()
        {
            ...
            {
                m_AuthenticationManager = FindFirstObjectByType<AuthManager>();
            }
        ...
        private void SetupAuthenticationEvents()
        {
            ...
            AuthManager.OnRegistrationFailed += HandleRegistrationFailed;
        }
